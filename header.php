        ...
        <header class="navbar ">
            ...
            <div class="left">
                ...
                <div class="cart flex-center">
                    ...
                    <svg class="cart-icon" onclick="saveData()" style="cursor: pointer;" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="ast-basket-icon-svg" x="0px" y="0px" width="100" height="100" viewBox="826 826 140 140" enable-background="new 826 826 140 140" xml:space="preserve">
                        ...
                        <ul class="cart-body">
                            <table class="cart-table">
                                <tr class="cart-table-row">
                                    <td rowspan="2" class="product-img">
