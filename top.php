...
<head>
    ...
    <link rel="stylesheet" href="asset/shop/">
    ...
    <link rel="stylesheet" href="asset/style/top_top.css">
    <!-- js -->
...
<body>
    ...
    <div class="header-wrapper">
        ...
        <main class="header-body">
            <div class="nav-location" style="margin: 1em 0;">
                <a href="shop.html">SHOP</a> / <a href="top.html">TOP</a>
            </div>
